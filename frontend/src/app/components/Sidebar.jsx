...
import {
  ...
  LogOut, Monitor, MapPinCheck, Navigation2, NotepadText,
} from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto px-2 space-y-2 text-center">
        ...
        {user && (
          <>
            ...
            <CustomIconLink href="/changelogs" icon={<NotepadText />} text="Change Logs" collapsed={collapsed} />
        ...
        {user && (
          <>
            ...
            <CustomIconLink href="/movements" icon={<Navigation2 />} text="Movements" collapsed={collapsed} />
            {role === 'admin' && (
