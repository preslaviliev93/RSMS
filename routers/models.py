...
class Routers(models.Model):
    ...
    router_hardware = models.CharField(max_length=20, null=False, blank=False, default="")
    router_identity = models.CharField(max_length=20, null=False, blank=False, default="")
    ...
    router_uptime = models.CharField(max_length=35, blank=True, default="")
